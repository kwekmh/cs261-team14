...
public interface TradeRepository extends CrudRepository<Trade, Integer>, Serializable {
    ...
    Iterable<Trade> findTop10ByIsAnomalousGreaterThanOrderByTimeDesc(int isAnomalous);
    Iterable<Trade> findByIsAnomalousGreaterThanAndTimeBetween(int isAnomalous, Timestamp start, Timestamp end);
    Iterable<Trade> findByIsAnomalousGreaterThanAndSymbolIdAndTimeBetween(int isAnomalous, int symbolId, Timestamp start, Timestamp end);
    Iterable<Trade> findByBuyerIdOrSellerIdAndTimeBetween(int buyerId, int sellerId, Timestamp start, Timestamp end);
    Page<Trade> findByIsAnomalousGreaterThanOrderByTimeDesc(int isAnomalous, Pageable pageable);
}
